...
public class EmployeeAddEditActivity extends AppCompatActivity {
    ...
    private final String[] POSITION_LIST = {"Engineering Manager", "Tech Lead", "Senior Software Engineer", "Software Engineer", "Junior Software Engineer", "Mobile Developer", "Backend Developer", "Frontend Developer", "Fullstack Developer", "QA Engineer", "DevOps Engineer", "UI/UX Designer", "Product Manager", "Business Analyst", "HR Executive", "Accountant"
    };

    private final String[] DEPARTMENT_LIST = {"Engineering", "Product", "Quality Assurance", "DevOps / Infrastructure", "UI/UX Design", "Human Resources", "Finance & Accounting", "Sales", "Marketing", "Customer Support"
    };
